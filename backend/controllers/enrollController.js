...
export async function getAllEnrollments(request, response) {
    try {
...
export async function getEnrollmentById(request, response) {
    try {
...
export async function getEnrollmentByUserId(request, response) {
    try {
        const { id } = request.params;
...
export async function getEnrollmentBySubjectId(request, response) {
    try {
        const { id } = request.params;
...
export async function saveNewEnroll(request, response) {
    try {
        // Input validation
        if (
            !request.body.userId ||
...
export async function updateEnrollment(request, response) {
    try {
...
export async function deleteEnrollmentById(request, response) {
    try {
        const { id } = request.params;
